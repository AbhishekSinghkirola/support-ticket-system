                    ...
                    <div class="card-body">
                        ...
                        <form id="register-form" class="mb-3" action="#">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="mobile" name="email" placeholder="Enter your mobile" />
                            </div>
                            ...
                            <button class="btn btn-primary d-grid w-100" id="register">Sign up</button>
                        </form>
